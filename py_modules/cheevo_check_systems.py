...
SYSTEMS = (
    ...
    System(19, "Wii", "Wii",
           folders=("wii", "wiiware", "primehacks"),
    ...
    System(1, "MD", "Genesis/Mega Drive",
           folders=("genesis", "megadrive", "genesismegadrive", "megadrivegenesis",
                    "md", "gen", "gendesktop", "megadrivejp", "genesiswide"),
    ...
    System(76, "PCCD", "PC Engine CD/TurboGrafx-CD",
           folders=("pcenginecd", "pcecd", "tg16cd", "turbografxcd", "tg-cd"),
    ...
    System(56, "NGCD", "Neo Geo CD",
           folders=("neogeocd", "ngcd", "neogeocdjp"),
           extensions=(".cue", ".chd"),
           dat_key="neogeocd",
